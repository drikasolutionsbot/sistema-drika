...
async function handleClear(interaction, tenant) {
  try {
    ...
    await interaction.reply({ content: "<a:carregadeira:1515809475922100426> Limpando mensagens...", ephemeral: true });
...
async function handleBan(interaction, tenant) {
  ...
  await interaction.reply({ content: "<a:carregadeira:1515809475922100426> Aplicando ban...", ephemeral: true });
...
async function handleKick(interaction, tenant) {
  ...
  await interaction.reply({ content: "<a:carregadeira:1515809475922100426> Aplicando kick...", ephemeral: true });
