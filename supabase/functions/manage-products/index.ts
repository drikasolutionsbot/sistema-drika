...
serve(async (req) => {
  ...
  try {
    ...
    if (action === "update") {
      ...
      const allowedFields = ["name", "description", "price_cents", "compare_price_cents", "type", "active", "icon_url", "banner_url", "auto_delivery", "category_id", "stock", "enable_credits", "show_stock", "show_sold", "enable_instructions", "button_style", "embed_config", "role_id", "payment_provider_key", "language"];
