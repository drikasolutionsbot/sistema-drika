...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen text-white overflow-x-hidden relative bg-black">
      ...
      <a
        href="https://discord.gg/cd2sk2kMfC"
        target="_blank"
        ...
        <ScrollReveal>
          <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-4">
              <a href="https://discord.gg/cd2sk2kMfC" target="_blank" rel="noopener noreferrer" className="relative z-30 cursor-pointer text-white/70 hover:text-primary transition-colors" aria-label="Discord">
