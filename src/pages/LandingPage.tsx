    ...
    <div className="min-h-screen text-white overflow-x-hidden relative bg-black">
      ...
      <section className="relative z-10 min-h-[80vh] flex flex-col items-center justify-center px-4 py-12">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-5xl font-extrabold font-display mb-3 leading-tight animate-fade-in drop-shadow-[0_2px_20px_rgba(0,0,0,0.6)] text-[#ff6bc9] text-center" style={{ textShadow: "-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000" }}>
            Conheça o Bot de vendas
            <br />
            <span className="drop-shadow-none">mais completo para o Discord</span>
          </h1>

          <p className="text-base md:text-lg text-[#ff6bc9] max-w-xl mx-auto mb-8 animate-fade-in font-medium drop-shadow-[0_1px_4px_rgba(0,0,0,0.8)] text-center" style={{ animationDelay: "0.1s", textShadow: "1px 1px 2px #000" }}>
