...
import drikaMine from "@/assets/drika_mine.png";
const LoginPage = () => {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="hidden lg:flex flex-1 items-end justify-center relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-bl from-primary/10 via-transparent to-transparent" />
        <img
          src={drikaMine}
          alt="Drika Minecraft"
          className="relative z-10 h-[85vh] max-h-[800px] object-contain drop-shadow-2xl animate-fade-in"
